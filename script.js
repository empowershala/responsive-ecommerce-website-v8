...
sr.reveal(`.home-right`, { origin: 'right', delay: 1200})
sr.reveal(`.feature-box`, { origin: 'left', delay: 2000, interval: 600 })
sr.reveal(`.explore-box`, { origin: 'left', interval: 1000 })
sr.reveal(`.signup-content-left`, { origin: 'right' })
sr.reveal(`.signup-content-right`, { origin: 'left', delay: 1200 })
